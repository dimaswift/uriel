...
namespace Uriel.Behaviours
{
    public class Painter : MonoBehaviour
    {
        ...
        private RenderTexture interference;
        ...
        private void Start()
        {
            ...
            gameObject.AddComponent<WaveBuffer>().Init(harbor).LinkComputeKernel(compute);
            
            field = CreateTexture();
            canvas = CreateTexture();
            interference = CreateTexture();
            ...
            compute.SetTexture(calculateFieldKernel, ShaderProps.Interference, interference);
            ...
            compute.SetTexture(simulateParticlesKernel, ShaderProps.Interference, interference);
            ...
            interferenceRenderer.material.mainTexture = interference;
        ...
        private void Update()
        {
            ...
            {
                FileUtils.SaveTextureAsPNG(field, "C:/Unity/uriel/unity/Uriel/Generated/Projections/", Guid.NewGuid().ToString().Substring(0, 5).ToUpper());
            }
        ...
        {
            if (interference) interference.Release();
