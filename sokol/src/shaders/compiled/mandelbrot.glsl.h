...
/*
    ...
    Cmdline:
        sokol-shdc --input ./mandelbrot.glsl --output ./compiled/mandelbrot.glsl.h --slang glsl430:hlsl5:metal_macos
    ...
    Shader program: 'mandelbrot':
        ...
        Fragment Shader: fs
        Attributes:
            ATTR_mandelbrot_position => 0
            ATTR_mandelbrot_color0 => 1
    Bindings:
...
#endif
#endif
#define ATTR_mandelbrot_position (0)
#define ATTR_mandelbrot_color0 (1)
...
static inline const sg_shader_desc* mandelbrot_shader_desc(sg_backend backend) {
